...
<head>
    ...
    <style type="text/css">
        ...
        .logo-login {
            padding: 30px;
            background-image: url("<?= base_url('assets/img/download.png'); ?>");
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-light sidebar sidebar-secondary accordion shadow-sm" id="accordionSidebar">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                <div class="sidebar-brand-icon">
                    <div class="logo-login" href="<?= base_url('assets/img/logo.png'); ?>"></div>
                </div>
                <div class="sidebar-brand-text mx-0">
                <div class="sidebar-brand-text mx-3 text-center">SIBARIS</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-info py-4 collapse-inner rounded">
        ...
        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column-reverse bd-highlight">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-dark bg-info topbar mb-3 static-top shadow-sm">

                    <!-- Sidebar Toggle (Topbar) -->
                    <button id="sidebarToggleTop" class="btn btn-link bg-dark d-md-none rounded-circle mr-5">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?= base_url('profile'); ?>">
                                    <i class="fas fa-user-circle fa-sm fa-fw mr-4 text-primary-600"></i>
                                    Profile
                                </a>
                                <a class="dropdown-item" href="<?= base_url('profile/setting'); ?>">
                                    <i class="fas fa-cogs fa-sm fa-fw mr-4 text-primary-600"></i>
                                    Settings
                                </a>
                                <a class="dropdown-item" href="<?= base_url('profile/ubahpassword'); ?>">
                                    <i class="fas fa-key fa-sm fa-fw mr-4 text-primary-600"></i>
                                    Change Password
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                                    <i class="fas fa-sign-out-alt fa-sm fa-fw mr-4 text-primary-600"></i>
                                    Logout
                                </a>
                            </div>
                        </li>
            ...
            <!-- <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SIBARIS &bull; by Nim</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
