        ...
        <div class="card shadow-sm border-bottom-info">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-left" for="transaksi">Pilih Laporan</label>
                    <div class="col-md-7">
                ...
                <div class="row form-group">
                    <label class="col-lg-4 text-lg-left" for="tanggal">Tanggal</label>
                    <div class="col-lg-7">
